...
def parse_arguments_install(args: List[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        "genome",
        help="The reference genome to install. Supported genomes include {c_elegans, CHM13-T2T, dog, ebv, GRCh37, GRCh38, GRCh38_Legacy, mm9, mm10, mm39, rn6, rn7, yeast}.",
    )
    parser.add_argument(
        "-l",
        "--local_genome",
...
def parse_arguments_matrix_generator(args: List[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        "reference_genome",
        help="The name of the reference genome. Supported values {c_elegans, CHM13-T2T, dog, ebv, GRCh37, GRCh38, GRCh38_Legacy, mm9, mm10, mm39, rn6, rn7, yeast}.",
    )
